...
function getBrowserCompat() {
    return globalThis.GrabbitBrowserCompat || {
        ...
        supportsInlineRating: typeof chrome !== 'undefined' && typeof chrome.webstore?.postRating === 'function',
    };
}
...
class GrabbitFooter {
            ...
            <footer class="footer">
                <div class="footer-content">
                    ...
                    <div class="footer-col brand-col">
                        ...
                        <p class="brand-desc">
                            The ultimate drag-select productivity tool for your browser.
    ...
    initLogic() {
        ...
        if (rateButton && !rateButton.dataset.grabbitClickBound) {
            rateButton.dataset.grabbitClickBound = 'true';
            rateButton.addEventListener('click', () => {
                if (compat.supportsInlineRating) {
                    try {
                ...
                window.open(compat.feedbackUrl, '_blank');
            });
        }

        // Pin button functionality (if pin button exists)
        const pinButton = document.getElementById('pinExtensionButton');
        if (pinButton && !pinButton.dataset.grabbitClickBound) {
            pinButton.dataset.grabbitClickBound = 'true';
            pinButton.addEventListener('click', () => {
                window.open(compat.pinHelpUrl, '_blank');
            });
        }
    }
}
